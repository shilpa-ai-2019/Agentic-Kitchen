...
def generate_recipes_recommendations():
    ...
    userInputDictionary = {
        "nickname": st.session_state.nickname.strip() or "User",
        ...
        "userSearchTerm": st.session_state.userSearchTerm.strip(),
...
def generate(userInputDictionary):
    ...
    {updatedSearchTerm1} for user: {nickname1}.  
    user's current food preferences are:
    - Servings: {servings1}
    - Diet Type: {dietType1}
